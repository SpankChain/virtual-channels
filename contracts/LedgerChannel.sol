...
contract LedgerChannel {
    ...
    function initVCstate(bytes32 _lcID, bytes32 _vcID, bytes _proof, uint256 _sequence, address _partyA, address _partyB, uint256 _balanceA, uint256 _balanceB, string sigA) public {
    ...
    function settleVC(bytes32 _lcID, bytes32 _vcID, uint256 updateSeq, address _partyA, address _partyB, uint256 updateBalA, uint256 updateBalB, string sigA) public {
        // sub-channel must be open
        require(virtualChannels[_vcID].isClose == 0);
